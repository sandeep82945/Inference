...
prompt = """Question: What are new future idea/work/direction that can be done for the research paper as follows identify potential areas for further investigation or development: 
...
```
Answer: """
print(model.generate(prompt, new_doc=True, max_new_tokens=500))